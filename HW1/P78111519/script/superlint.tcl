...
# own constrain
config_rtlds -rule  -disable -tag { FIL_NR_CTLC INS_NR_INPR OTP_NR_ASYA OTP_UC_INST OTP_NR_UDRV INP_NO_USED IDN_NR_CKYW FLP_NR_MXCS}
# config_rtlds -rule  -disable -tag { CAS_NR_DEFX }
